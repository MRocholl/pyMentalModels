...
\begin{enumerate}
	\item Models represent \textblue{possibilities} {\footnotesize{(J-L \& Byrne, 1991)}} \smallskip 
	\item Compounds of \textblue{alternatives} refer by default to
...
\end{center}
	...
	\item A \textblue{conjunction}, \textit{A and B}, makes a factual claim: 
	both propositions hold in all possibilities. \smallskip
	\item \textblue{Parsimony:} \textit{possible that A and possible that B}  
...
\end{enumerate}
	...
	\begin{itemize}
		\item \textblue{Parsimony unifies possibilities}, e.g.: \\
